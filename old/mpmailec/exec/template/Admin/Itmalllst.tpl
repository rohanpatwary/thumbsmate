	...
	<table class="tbl2 tbldeco" summary="フォーム項目一覧">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<TMPL_IF NAME="offset_up"><a href="%CGI_URL%?m=itmoftchg&amp;name=%name_urlenc%&amp;offset=%offset_up%" class="fancy_button_link"><img src="%static_url%/imgs/ico_up 20.png" width="20" height="20" alt="上へ" /></a><TMPL_ELSE><img src="%static_url%/imgs/ico_up_disabled_20.png" width="20" height="20" alt="移動できません" /></TMPL_IF>
					<TMPL_IF NAME="offset_dn"><a href="%CGI_URL%?m=itmoftchg&amp;name=%name_urlenc%&amp;offset=%offset_dn%" class="fancy_button_link"><img src="%static_url%/imgs/ico_dn 20.png" width="20" height="20" alt="下へ" /></a><TMPL_ELSE><img src="%static_url%/imgs/ico_dn_disabled_20.png" width="20" height="20" alt="移動できません" /></TMPL_IF>
				</td>
